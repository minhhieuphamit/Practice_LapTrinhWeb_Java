package phamminhhieu.springsecurity_logindb;
        ...
        http.csrf((csrf) -> csrf.disable())
                .authorizeHttpRequests((authorize) ->
                        authorize
                                ...
                                .requestMatchers("/product/create").hasAuthority("ROLE_ADMIN")
                                .requestMatchers("/product/save").hasAuthority("ROLE_ADMIN")
                                .requestMatchers("/product/updateProduct/** ").hasAuthority("ROLE_ADMIN")
